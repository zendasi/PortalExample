...
public class LangManager extends AbstractService implements ILangManager {
	 ...
	 * @uml.associationEnd  qualifier="code:java.lang.String com.agiletec.aps.system.services.lang.Lang"
	 */
	private Map<String, Lang> _langs;
	
	/**
	 * Map delle lingue assegnabili al sistema,  per il recupero in base al codice.
	 * @uml.property  name="_assignableLangs"
	 * @uml.associationEnd  qualifier="code:java.lang.String com.agiletec.aps.system.services.lang.Lang"
	 */
