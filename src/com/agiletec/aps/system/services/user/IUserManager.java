...
public interface IUserManager {
	...
	/**
	 * Restituisce l'utente di default di sistema. L'utente di default rappresenta un utente "ospite" senza nessuna autorizzazione  di accesso ad elementi non "liberi" e senza nessuna autorizzazione ad eseguire  qualunque azione sugli elementi del sistema. 
	 * @return   L'utente di default di sistema.
	 * @uml.property  name="guestUser"
	 * @uml.associationEnd  
	 */
