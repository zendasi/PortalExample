...
public class ShowletTypeDAO extends AbstractDAO implements IShowletTypeDAO {
	...
	/**
	 * @uml.property  name="aLL_SHOWLET_TYPES"
	 */
	...
	/**
	 * @uml.property  name="aDD_SHOWLET_TYPE"
	 */
