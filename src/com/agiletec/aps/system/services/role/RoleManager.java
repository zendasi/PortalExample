...
public class RoleManager extends AbstractApsAutorityManager implements IRoleManager {
	 ...
	 * @uml.associationEnd  qualifier="getName:java.lang.String com.agiletec.aps.system.services.role.Role"
	 */
	private Map<String, Role> _roles;
	/**
	 * @uml.property  name="_permissions"
	 * @uml.associationEnd  qualifier="permissionName:java.lang.String com.agiletec.aps.system.services.role.Permission"
	 */
	...
	/**
	 * @uml.property  name="permissionDao"
	 * @uml.associationEnd  
	 */
