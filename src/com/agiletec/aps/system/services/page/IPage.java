...
public interface IPage extends ITreeNode {
	...
	/**
	 * WARING: this method is reserved to the page manager service only. Return the code of the father of this page. This methods exists only to simplify the loading of the pages structure, it cannot be used in any other  circumstance.
	 * @return  the code of the higher level page
	 * @uml.property  name="parentCode"
	 */
	...
	/**
	 * Return the parent of the current page.  If the current page is the root, the root page itself is returned
