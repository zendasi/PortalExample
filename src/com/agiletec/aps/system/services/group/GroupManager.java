...
public class GroupManager extends AbstractApsAutorityManager implements IGroupManager  {
	...
	/**
	 * La mappa dei gruppi presenti nel sistema  indicizzata in base al nome del gruppo.
	 * @uml.property  name="_groups"
	 * @uml.associationEnd  qualifier="getName:java.lang.String com.agiletec.aps.system.services.group.Group"
	 */
	private Map<String, Group> _groups;
	
	/**
	 * @uml.property  name="_groupDao"
	 * @uml.associationEnd  
	 */
