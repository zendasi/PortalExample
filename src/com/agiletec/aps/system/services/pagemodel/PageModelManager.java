...
public class PageModelManager extends AbstractService implements IPageModelManager {
	 ...
	 * @uml.property  name="_models"
	 * @uml.associationEnd  qualifier="name:java.lang.String com.agiletec.aps.system.services.pagemodel.PageModel"
	 */
	private Map<String, PageModel> _models;

	/**
	 * @uml.property  name="_pageModelDao"
	 * @uml.associationEnd  
	 */
