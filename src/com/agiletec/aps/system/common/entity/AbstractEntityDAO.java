...
public abstract class AbstractEntityDAO extends AbstractDAO implements IEntityDAO {
	...
	/**
	 * @uml.property  name="addEntityRecordQuery"
	 */
	...
	/**
	 * @uml.property  name="deleteEntityRecordQuery"
	 */
	...
	/**
	 * @uml.property  name="updateEntityRecordQuery"
	 */
	...
	/**
	 * @uml.property  name="loadEntityRecordQuery"
	 */
	...
	/**
	 * Return the specific query to add a new record of informations in the support database. The query must respect the following positions of the elements:<br /> Position 1: entity ID<br /> Position 2: attribute name<br /> Position 3: searchable string<br /> Position 4: searchable data<br /> Position 5: searchable number<br /> Position 6: Language code
	 * @return  the query to add a look up record for the entity search.
	 * @uml.property  name="addingSearchRecordQuery"
	 */
	protected abstract String getAddingSearchRecordQuery();
	
	/**
	 * Return the query to delete the record associated to an entity. The returned query will only need the declaration of the ID of the entity to delete.
	 * @return   The query to delete the look up record of a single entity.
	 * @uml.property  name="removingSearchRecordQuery"
	 */
	 ...
	 * @uml.property  name="extractingAllEntityIdQuery"
	 */
