...
/**
 * This abstract service must be extended in all those services that make use of ApsEntities. By default, extending the manager, it is necessary to implement the method that returns the specific  category manager and, in the definition of the Spring service, the configuration item where to look  for the definitions of the Entity Types handled by the service.
 * @author  E.Santoboni
 */
public abstract class ApsEntityManager extends AbstractService 
	...
	private void updateEntityPrototypes(Map<String, IApsEntity> newEntityTypes) throws ApsSystemException {
		try {
			this._entityTypeFactory.updateEntityTypes(newEntityTypes, this.getConfigItemName(), this._entityTypeDom);
			this.refresh();
		} catch (Throwable t) {
	 ...
	 * @uml.property  name="entitySearcherDao"
	 * @uml.associationEnd  readOnly="true"
	 */
	 ...
	 * @uml.property  name="_entityTypes"
	 * @uml.associationEnd  qualifier="typeCode:java.lang.String com.agiletec.plugins.jacms.aps.system.services.content.model.Content"
	 */
	private Map<String, IApsEntity> _entityTypes;

	/**
	 * @uml.property  name="_entityTypeFactory"
	 * @uml.associationEnd  
	 */
	private IEntityTypeFactory _entityTypeFactory;

	/**
	 * @uml.property  name="_entityClass"
	 */
	private Class _entityClass;

	/**
	 * @uml.property  name="_configItemName"
	 */
	private String _configItemName;

	/**
	 * @uml.property  name="_entityTypeDom"
	 * @uml.associationEnd  
	 */
	private IEntityTypeDOM _entityTypeDom;

	/**
	 * @uml.property  name="_entityHandler"
	 * @uml.associationEnd  
	 */
	private EntityHandler _entityHandler;

	/**
	 * @uml.property  name="_xmlAttributeRootElementName"
	 */
	private String _xmlAttributeRootElementName;

	/**
	 * @uml.property  name="_entityDom"
	 * @uml.associationEnd  
	 */
	...
	/**
	 * @uml.property  name="_typesStatus"
	 * @uml.associationEnd  qualifier="typeCode:java.lang.String java.lang.Integer"
	 */
	private Map<String, Integer> _typesStatus = new HashMap<String, Integer>();
	
	/**
	 * @uml.property  name="_attributeRoles"
	 * @uml.associationEnd  qualifier="roleName:java.lang.String com.agiletec.aps.system.common.entity.model.attribute.AttributeRole"
	 */
	private Map<String, AttributeRole> _attributeRoles = null;
	
	/**
	 * @uml.property  name="_attributeDisablingCodes"
	 */
	private Map<String, String> _attributeDisablingCodes = null;
	
	/**
	 * @uml.property  name="_attributeRolesFileName"
	 */
	private String _attributeRolesFileName;
	
	/**
	 * @uml.property  name="_attributeDisablingCodesFileName"
	 */
