...
public class TextAttribute extends AbstractTextAttribute {
	...
	protected void addTextElements(Element attributeElement) {
		if (null == this.getTextMap()) return;
	...
	/**
	 * @uml.property  name="_textMap"
	 * @uml.associationEnd  multiplicity="(0 -1)" ordering="true" elementType="com.agiletec.plugins.jacms.aps.system.services.content.model.SymbolicLink" qualifier="currentLangCode:java.lang.String java.lang.String"
	 */
