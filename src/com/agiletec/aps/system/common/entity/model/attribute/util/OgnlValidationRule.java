...
public class OgnlValidationRule {
	...
	/**
	 * @uml.property  name="_evalExpressionOnValuedAttribute"
	 */
	private boolean _evalExpressionOnValuedAttribute;
	/**
	 * @uml.property  name="_errorMessage"
	 */
	private String _errorMessage;
	/**
	 * @uml.property  name="_errorMessageKey"
	 */
	private String _errorMessageKey;
	/**
	 * @uml.property  name="_helpMessage"
	 */
	private String _helpMessage;
	/**
	 * @uml.property  name="_helpMessageKey"
	 */
