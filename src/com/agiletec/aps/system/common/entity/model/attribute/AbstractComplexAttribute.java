...
/**
 * Abstract class used for the implementation of "Complex Attributes". Complex attributes are those  constituted by the aggregation, in different ways, of "Simple Attributes".
 * @author  E.Santoboni
 */
public abstract class AbstractComplexAttribute extends AbstractAttribute {
	 ...
	 * @uml.property  name="renderingAttributes"
	 */
