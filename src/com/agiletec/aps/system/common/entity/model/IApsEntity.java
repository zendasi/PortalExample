...
/**
 * This class represents an Entity. The structure of the entity, defined during the configuration process, is built invoking the method 'addAttribute', but this procedure is reserved for the Content Service which invokes this method only during the system initialization. The standard procedure to instantiate an entity, used during the normal execution of the system,  is to make a request to the service: it will clone the prototype of the entity previously  defined in the configuration.
 * @author  E. Santoboni
 */
public interface IApsEntity {
	 ...
	 * @uml.property  name="entityPrototype"
	 * @uml.associationEnd  
	 */
