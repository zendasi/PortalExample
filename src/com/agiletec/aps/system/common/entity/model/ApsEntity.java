...
public class ApsEntity implements IApsEntity, Serializable {
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="com.agiletec.aps.system.services.page.IPage"
	 */
	private Set<String> _groups;
	/**
	 * @uml.property  name="_attributeList"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="com.agiletec.aps.system.common.entity.model.attribute.AttributeInterface"
	 */
	private List<AttributeInterface> _attributeList;
	/**
	 * @uml.property  name="_attributeMap"
	 * @uml.associationEnd  qualifier="constant:java.lang.String com.agiletec.aps.system.common.entity.model.attribute.DateAttribute"
	 */
	...
	/**
	 * @uml.property  name="_defaultLang"
	 */
