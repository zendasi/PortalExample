...
public class EntityTypeDOM implements IEntityTypeDOM {
	...
	/**
	 * @uml.property  name="_attributeTypes"
	 * @uml.associationEnd  qualifier="typeCode:java.lang.String com.agiletec.aps.system.common.entity.model.attribute.AttributeInterface"
	 */
	private Map<String, AttributeInterface> _attributeTypes;
	/**
	 * @uml.property  name="_entityTypes"
	 * @uml.associationEnd  qualifier="getTypeCode:java.lang.String com.agiletec.aps.system.common.entity.model.IApsEntity"
	 */
