...
public abstract class BaseEntityRenderer extends AbstractService implements IEntityRenderer, LogChute {
	...
	/**
	 * @uml.property  name="_entityWrapperContextName"
	 */
	private String _entityWrapperContextName;

	/**
	 * @uml.property  name="_charConversions"
	 * @uml.associationEnd  qualifier="conversionKey:java.lang.String com.agiletec.aps.system.common.renderer.TextAttributeCharReplaceInfo"
	 */
