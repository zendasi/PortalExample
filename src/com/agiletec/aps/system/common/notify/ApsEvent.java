...
/**
 * Base class for the implementation of the events to be notified to the event management service. The class that implements the event must exclusively know the interface through which the observing service (the final destination of the notification) must implement to properly handle the specific event.
...
public abstract class ApsEvent extends ApplicationEvent {
	...
	/**
	 * Return the object class of the interface that the observer service  have to implement to handle to event.
	 * @return  The interface class which the observer must implement
	 * @uml.property  name="observerInterface"
	 */
