...
/**
 * Interfaccia di utilità per il tag paginatore. Rappresenta l'oggetto che permette di estrarre i parametri necessari per la corretta  visualizzazione dell'iter corrente (l'insieme di oggetti "sottoinsieme della lista principale"  che deve essere visualizzato nella pagina corrente).
 * @author  E.Santoboni
 */
public interface IPagerVO {
	...
	/**
	 * Costruisce e restituisce il nome del parametro tramite il quale  individuare dalla request l'identificativo del item richiesto. Il metodo viene richiamato all'interno della jsp che genera il paginatore.
	 * @return  Il nome del parametro tramite il quale   individuare dalla request l'identificativo del item richiesto.
	 * @uml.property  name="paramItemName"
	 */
