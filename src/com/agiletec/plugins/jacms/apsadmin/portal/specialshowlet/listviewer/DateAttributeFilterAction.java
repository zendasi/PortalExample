...
public class DateAttributeFilterAction extends BaseFilterAction {
	...
	/**
	 * @uml.property  name="_dateValueType"
	 */
	private int _dateValueType = -1;
	/**
	 * @uml.property  name="_dateValue"
	 */
	private Date _dateValue;
	/**
	 * @uml.property  name="_dateStartType"
	 */
	private int _dateStartType = -1;
	/**
	 * @uml.property  name="_dateStart"
	 */
	private Date _dateStart;
	/**
	 * @uml.property  name="_dateEndType"
	 */
	private int _dateEndType = -1;
	/**
	 * @uml.property  name="_dateEnd"
	 */
