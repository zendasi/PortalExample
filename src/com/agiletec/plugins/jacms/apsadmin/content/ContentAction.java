...
public class ContentAction extends AbstractContentAction implements IContentAction {
	 ...
	 * @uml.associationEnd  multiplicity="(0 -1)" ordering="true" elementType="com.agiletec.aps.system.services.page.IPage" qualifier="constant:java.lang.String java.util.List"
	 */
	...
	/**
	 * @uml.property  name="_extraGroupName"
	 */
	private String _extraGroupName;
	
	/**
	 * @uml.property  name="_copyPublicVersion"
	 */
	private boolean _copyPublicVersion;
	
	/**
	 * @uml.property  name="_resourceIconUtil"
	 * @uml.associationEnd  
	 */
