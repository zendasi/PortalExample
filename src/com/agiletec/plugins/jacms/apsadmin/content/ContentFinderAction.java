...
public class ContentFinderAction extends AbstractApsEntityFinderAction implements IContentFinderAction {
	...
	/**
	 * @uml.property  name="_onLineState"
	 */
	private String _onLineState = "";
	/**
	 * @uml.property  name="_contentIdToken"
	 */
	private String _contentIdToken = "";
	/**
	 * @uml.property  name="_ownerGroupName"
	 */
	...
	/**
	 * @uml.property  name="_lastOrder"
	 */
	private String _lastOrder;
	/**
	 * @uml.property  name="_lastGroupBy"
	 */
	private String _lastGroupBy;
	/**
	 * @uml.property  name="_groupBy"
	 */
	private String _groupBy;
	
	/**
	 * @uml.property  name="_viewCode"
	 */
	private boolean _viewCode;
	/**
	 * @uml.property  name="_viewGroup"
	 */
	private boolean _viewGroup;
	/**
	 * @uml.property  name="_viewStatus"
	 */
	private boolean _viewStatus;
	/**
	 * @uml.property  name="_viewTypeDescr"
	 */
	private boolean _viewTypeDescr;
	/**
	 * @uml.property  name="_viewCreationDate"
	 */
	private boolean _viewCreationDate;
	
	/**
	 * @uml.property  name="_contentIds"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="java.lang.String"
	 */
	private Set<String> _contentIds;
	
	/**
	 * @uml.property  name="_actionCode"
	 */
