...
public class ContentManager extends ApsEntityManager 
	...
	/**
	 * Map of the prototypes of the content types in the so called 'small form', indexed by the type code.
	 * @uml.property  name="_smallContentTypes"
	 * @uml.associationEnd  qualifier="getCode:java.lang.String com.agiletec.plugins.jacms.aps.system.services.content.model.SmallContentType"
	 */
	private Map<String, SmallContentType> _smallContentTypes;
	
	/**
	 * @uml.property  name="_contentDao"
	 * @uml.associationEnd  
	 */
	private IContentDAO _contentDao;
	
	/**
	 * @uml.property  name="_workContentSearcherDAO"
	 * @uml.associationEnd  
	 */
	private IWorkContentSearcherDAO _workContentSearcherDAO;
	
	/**
	 * @uml.property  name="_publicContentSearcherDAO"
	 * @uml.associationEnd  
	 */
