...
public class ContentDAO extends AbstractEntityDAO implements IContentDAO {
	...
	/**
	 * @uml.property  name="dELETE_CONTENT_SEARCH_RECORD"
	 */
	private final String DELETE_CONTENT_SEARCH_RECORD =
		"DELETE FROM contentsearch WHERE contentid = ? ";
	
	/**
	 * @uml.property  name="aDD_WORK_CONTENT_SEARCH_RECORD"
	 */
	...
	/**
	 * @uml.property  name="lOAD_REFERENCED_CONTENTS_FOR_CONTENT"
	 */
	...
	/**
	 * @uml.property  name="lOAD_REFERENCED_CONTENTS_FOR_GROUP"
	 */
	...
	/**
	 * @uml.property  name="lOAD_REFERENCED_CONTENTS_FOR_RESOURCE"
	 */
	...
	/**
	 * @uml.property  name="lOAD_REFERENCED_CONTENTS_FOR_CATEGORY"
	 */
	...
	/**
	 * @uml.property  name="lOAD_CONTENTS_VO_MAIN_BLOCK"
	 */
	...
	/**
	 * @uml.property  name="iNSERT_ONLINE_CONTENT"
	 */
	...
	/**
	 * @uml.property  name="rEMOVE_ONLINE_CONTENT"
	 */
	...
	/**
	 * @uml.property  name="uPDATE_CONTENT"
	 */
	...
	/**
	 * @uml.property  name="lOAD_ALL_CONTENTS_ID"
	 */
