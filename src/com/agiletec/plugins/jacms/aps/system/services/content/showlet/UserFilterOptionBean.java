...
public class UserFilterOptionBean {
	...
	/**
	 * @uml.property  name="_attribute"
	 * @uml.associationEnd  
	 */
	private AttributeInterface _attribute;
	
	/**
	 * @uml.property  name="_currentFrame"
	 */
	private Integer _currentFrame;
	/**
	 * @uml.property  name="_currentLang"
	 * @uml.associationEnd  
	 */
	private Lang _currentLang;
	
	/**
	 * @uml.property  name="_formFieldNames" multiplicity="(0 -1)" dimension="1"
	 */
	private String[] _formFieldNames;
	/**
	 * @uml.property  name="_formFieldValues"
	 * @uml.associationEnd  qualifier="key:java.lang.String java.lang.String"
	 */
	private Map<String, String> _formFieldValues;
	/**
	 * @uml.property  name="_formFieldErrors"
	 * @uml.associationEnd  inverse="this$0:com.agiletec.plugins.jacms.aps.system.services.content.showlet.UserFilterOptionBean$AttributeFieldError" qualifier="fieldName:java.lang.String com.agiletec.plugins.jacms.aps.system.services.content.showlet.UserFilterOptionBean$AttributeFieldError"
	 */
