...
public class ContentModelManager extends AbstractService implements IContentModelManager {
	 ...
	 * @uml.property  name="_contentModels"
	 * @uml.associationEnd  qualifier="new:java.lang.Long com.agiletec.plugins.jacms.aps.system.services.contentmodel.ContentModel"
	 */
	private Map<Long, ContentModel> _contentModels;
	
	/**
	 * @uml.property  name="_contentModelDao"
	 * @uml.associationEnd  
	 */
