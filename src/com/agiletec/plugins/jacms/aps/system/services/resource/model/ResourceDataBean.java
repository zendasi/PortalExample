...
/**
 * Interfaccia base per l'implementazione degli oggetti detentori  degli elementi necessari per la costruzione degli oggetti risorsa.  Le classi concrete implementanti l'interfaccia sono idonee  ad essere passate al Manager delle risorse per ricavare  gli elementi per la costruzione di una nuova risorsa.
 * @author  E.Santoboni
 */
public interface ResourceDataBean {
	...
	/**
	 * Restituisce l'InputStream relativo  al file della risorsa da aggiungere.
