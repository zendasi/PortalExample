...
public class SearchEngineManager extends AbstractService 
	...
	private void manageEvent(PublicContentChangedEvent event) {
		...
		try {
			...
			ApsSystemUtils.getLogger().severe("Errore in notificazione evento");
		}
	}
    ...
    /**
	 * @uml.property  name="_searcherDao"
	 * @uml.associationEnd  
	 */
    ...
    private int _status;
    /**
	 * @uml.property  name="_lastReloadInfo"
	 * @uml.associationEnd  
	 */
    private LastReloadInfo _lastReloadInfo;
    /**
	 * @uml.property  name="_publicContentChangedEventQueue"
	 * @uml.associationEnd  multiplicity="(0 -1)" elementType="com.agiletec.plugins.jacms.aps.system.services.content.event.PublicContentChangedEvent"
	 */
    ...
    /**
	 * @uml.property  name="_newTempSubDirectory"
	 */
