...
public interface ResourceInterface {
    ...
    /**
	 * Restituisce la stringa identificante  il gruppo principale di cui la risorsa è membro.
	 * @return  Il gruppo principale di cui la risorsa è membro.
	 * @uml.property  name="mainGroup"
	 */
    public String getMainGroup();
    
    /**
	 * Setta la stringa identificante  il gruppo principale di cui il contenuto è membro.
	 ...
	 * @uml.property  name="masterFileName"
	 */
    ...
    /**
	 * Restituisce la cartella (a partire dalla cartella delle risorse)  dove è posizionata la risorsa.
    ...
    /**
	 * Setta la cartella (a partire dalla cartella delle risorse)  dove è posizionata la risorsa.
    ...
    /**
	 * Restituisce il path assoluto su disco del folder contenitore  dei file delle istanze relative alla risorsa specificata.  Questo path è necessario al salvataggio o alla rimozione dei file associati ad ogni istanza della risorse.
	 * @return  Il path assoluto su disco completo.
	 * @uml.property  name="diskFolder"
	 */
	 ...
	 * @uml.property  name="resourcePrototype"
	 * @uml.associationEnd  
	 */
