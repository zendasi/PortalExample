...
public abstract class AbstractResource implements ResourceInterface, Serializable {
	...
	/**
	 * @uml.property  name="_masterFileName"
	 */
	...
	/**
	 * @uml.property  name="_baseURL"
	 */
	private String _baseURL;
	/**
	 * @uml.property  name="_baseDiskRoot"
	 */
	private String _baseDiskRoot;
	/**
	 * @uml.property  name="_protectedBaseDiskRoot"
	 */
	private String _protectedBaseDiskRoot;
	/**
	 * @uml.property  name="_protectedBaseURL"
	 */
	private String _protectedBaseURL;
	
	/**
	 * @uml.property  name="_allowedExtensions"
	 */
	private String _allowedExtensions;
	
	/**
	 * @uml.property  name="_instanceHelper"
	 * @uml.associationEnd  
	 */
