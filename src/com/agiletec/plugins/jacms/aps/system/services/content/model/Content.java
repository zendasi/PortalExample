...
public class Content extends ApsEntity {
	...
	/**
	 * @uml.property  name="_onLine"
	 */
	private boolean _onLine;
	/**
	 * @uml.property  name="_viewPage"
	 */
	private String _viewPage;
	/**
	 * @uml.property  name="_listModel"
	 */
	private String _listModel;
	/**
	 * @uml.property  name="_defaultModel"
	 */
	private String _defaultModel;
	
	/**
	 * @uml.property  name="_created"
	 */
	private Date _created;
	/**
	 * @uml.property  name="_lastModified"
	 */
	private Date _lastModified;
	
	/**
	 * @uml.property  name="_version"
	 */
	private String _version;
	/**
	 * @uml.property  name="_lastEditor"
	 */
