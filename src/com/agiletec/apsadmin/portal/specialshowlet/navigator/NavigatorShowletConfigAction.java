...
public class NavigatorShowletConfigAction extends SimpleShowletConfigAction implements INavigatorShowletConfigAction {
	...
	/**
	 * @uml.property  name="_navSpec"
	 */
	private String _navSpec;
	
	/**
	 * @uml.property  name="_expressions"
	 */
	private List<NavigatorExpression> _expressions;
	/**
	 * @uml.property  name="_navigatorParser"
	 * @uml.associationEnd  
	 */
	private INavigatorParser _navigatorParser;
	
	/**
	 * @uml.property  name="_specId"
	 */
	private int _specId;
	/**
	 * @uml.property  name="_specSuperLevel"
	 */
	private int _specSuperLevel = -1;
	/**
	 * @uml.property  name="_specAbsLevel"
	 */
	private int _specAbsLevel = -1;
	/**
	 * @uml.property  name="_specCode"
	 */
	private String _specCode;
	
	/**
	 * @uml.property  name="_operatorId"
	 */
	private int _operatorId = -1;
	/**
	 * @uml.property  name="_operatorSubtreeLevel"
	 */
	...
	/**
	 * @uml.property  name="_expressionIndex"
	 */
