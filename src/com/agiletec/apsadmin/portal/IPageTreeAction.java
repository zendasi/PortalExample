...
public interface IPageTreeAction extends ITreeAction {
	...
	/**
	 * Return the root node if the page tree depending on the privileges of the current user. The root can be either the effective root or a 'virtual' node whose leaves are the pages which the current user is allowed to access. 
	 * @return   The root of the page tree.
	 * @deprecated   As of version 2.2 use   {@link #getAllowedTreeRootNode()}  
	 * @uml.property  name="treeRootNode"
	 * @uml.associationEnd  
	 */
