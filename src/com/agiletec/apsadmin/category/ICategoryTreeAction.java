...
public interface ICategoryTreeAction {
	...
	/**
	 * Return the root node of the categories tree which the current user is granted to access.  The node may be the effective root of the category tree or a virtual node which contains only some qualified category.
