...
public class JapsPluginLabelListener implements ServletContextListener {
	...
	/**
	 * This contains all the directories to exclude from the recursive search when  PLUGIN_DIRECTORY does NOT exist in the URL or path
	 * @uml.property  name="_plugin_exclusion_directories"
