...
public class ChainingInterceptor extends AbstractInterceptor {
    ...
    /**
	 * @uml.property  name="excludes" multiplicity="(0 -1)"
	 */
    protected Collection<String> excludes;
    /**
	 * @uml.property  name="includes" multiplicity="(0 -1)"
	 */
    protected Collection<String> includes;
    /**
	 * @uml.property  name="compoundRootMinSize"
	 */
    private Integer compoundRootMinSize = 3;
    
	/**
	 * @uml.property  name="reflectionProvider"
	 * @uml.associationEnd  
	 */
