...
public class AttributeTracer {
	...
	/**
	 * @uml.property  name="_lang"
	 * @uml.associationEnd  
	 */
	private Lang _lang;
	/**
	 * @uml.property  name="_monoListElement"
	 */
	private boolean _monoListElement = false;
	/**
	 * @uml.property  name="_listElement"
	 */
	private boolean _listElement = false;
	/**
	 * @uml.property  name="_listLang"
	 * @uml.associationEnd  
	 */
	private Lang _listLang = null;
	/**
	 * @uml.property  name="_listIndex"
	 */
	private int _listIndex = -1;
	
	/**
	 * @uml.property  name="_compositeElement"
	 */
	private boolean _compositeElement = false;
	/**
	 * @uml.property  name="_parentAttribute"
	 * @uml.associationEnd  
	 */
