...
/**
 * Interceptor gestore della verifica delle autorizzazioni dell'utente corrente. Verifica che l'utente corrente sia abilitato all'esecuzione dell'azione richiesta.
 * @author  E.Santoboni
 */
public abstract class BaseInterceptorMadMax extends AbstractInterceptor {
	 ...
	 * @uml.property  name="requiredPermission"
	 */
	public abstract String getRequiredPermission();
	
	/**
	 * @uml.property  name="errorResultName"
	 */
