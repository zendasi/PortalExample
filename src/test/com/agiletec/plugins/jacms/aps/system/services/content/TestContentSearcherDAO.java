...
import com.agiletec.plugins.jacms.aps.system.services.content.ContentSearcherDAO;
...
public class TestContentSearcherDAO extends BaseTestCase {
	...
	private void init() throws Exception {
		try {
			_contentSearcherDao = new ContentSearcherDAO();
			DataSource dataSource = (DataSource) this.getApplicationContext().getBean("portDataSource");
			((ContentSearcherDAO) _contentSearcherDao).setDataSource(dataSource);
		} catch (Throwable t) {
	...
	/**
	 * @uml.property  name="_contentSearcherDao"
	 * @uml.associationEnd  
	 */
